...
from force_regression.data.preprocessing.emg import get_emg_electrode_bounds
...
class SnnEMGDatasetPreparation():
    ...
    def __init__(self, emg_force_df:pd.DataFrame, data_config: DataConfig, snn_config: SNNConfig, select_dir: bool,
                 dataset_type:str, shuffle_fingers_seed: int = 1):
        self.data_config = data_config
